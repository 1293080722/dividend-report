...
VALUATION_LOGIC = {
    ...
    "600900": "2025年全年派10.0元，每股1.00元（中期0.21+末期0.79）。PE 18.01，按全年分红1.00元计算股息率约3.76%。来水偏丰+六库联调支撑业绩，但当前PE已反映大部分利好。作为类债券标的，建仓需等待股息率回到3.3%以上（对应股价约30.40元）。",
...
BUILD_LOGIC = {
    ...
    "600900": ("股息率3.3%对应价 ≈ 30.40<br>（PE 16.3 合理估值）",
                "股息率3.6%对应价 ≈ 27.86<br>（PE 15.0 历史低估）"),
